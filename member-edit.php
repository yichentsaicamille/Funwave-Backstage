            ...
            <div>
                ...
                <form class="row g-3 mt-5 pb-5 d-flex justify-content-center" action="member-update.php" method="post">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="<?=$row["name"]?>" placeholder="請輸入姓名">
                    </div>
                    <div class="col-md-5">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone"value="<?=$row["phone"]?>" placeholder="請輸入電話">
                    </div>
                    <div class="col-md-5">
                        <label for="email" class="form-label">信箱</label>
                        <input type="email" class="form-control" id="email" name="email"value="<?=$row["email"]?>" placeholder="請輸入email">
                    </div>
                    <div class="col-md-5">
                        <label for="account" class="form-label">帳號</label>
                        <input type="text" class="form-control" id="account" name="account"value="<?=$row["account"]?>" placeholder="請輸入帳號">
                    </div>
                    <div class="col-md-5">
                        <label for="password" class="form-label">密碼</label>
                        <input type="password" class="form-control" id="password" name="password"value="<?=$row["password"]?>" placeholder="請輸入密碼">
                    </div>
                    <div class="col-10">
