        ...
        <article class="article col-lg-9 shadow-sm table-responsive">
            <div class="tabs-group">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="spot-list.php">浪點清單</a>
                    </li>
                    <li class="nav-item">
                ...
                <?php if ($course_rows > 0) : ?>
                    <table class="table table-control  table-sm table-striped align-middle my-3">
                        ...
                        <?php foreach($resultTotal as $value) : ?>
                            <tr>
                                <td><a role="button" href="examineSpot.php?spot_code=<?= $value["spot_code"] ?>" class=""><i class="fas fa-search"></i></a></td>
                                <td><?= $value["spot_code"] ?></td>
                                <td><?= $value["spot_name"] ?></td>
                                <td><?= $value["spot_location"] ?></td>
                                <td>
                                    <a role="button" href="updateSpot.php?spot_code=<?= $value["spot_code"] ?>" class=""><i class="fas fa-edit"></i></a> / 
                                    <a role="button" href="method/deleteSpot.php?spot_code=<?= $value["spot_code"] ?>" class="" onclick="javascript:return del()" value="delete"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    ...
                    <?php if(isset($p)): ?>
                        <nav aria-label="Page navigation example ">
                            <ul class="pagination justify-content-center">
                                <li class="page-item"><a class="page-link" href="spot-list.php?p=1">第一頁</a></li>
                                ...
                                <?php endfor; ?>
                                <li class="page-item"><a class="page-link" href="spot-list.php?p=<?=$pageCount?>"> 最末頁</a></li>
                            </ul>
                        </nav>
                    <?php endif; ?>
                <?php else : ?>
