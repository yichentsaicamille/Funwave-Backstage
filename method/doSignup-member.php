...
$sqlMember="INSERT INTO member(member_name, member_account, member_password, member_gender, member_phone, member_email, member_created_at, member_valid) VALUES('$member_name', '$member_account', '$member_password', '$member_gender', '$member_phone', '$member_email', '$now', '$member_valid')";
