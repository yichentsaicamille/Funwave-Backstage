    ...
    <?php require_once("./public/admin-header-logined.php"); ?>
        ...
        <div class="col-9 button-group shadow-sm">
            <form class=" d-flex justify-content-between align-items-center" method="get">
                <div class="my-3">
                    <a role="button" href="addCourseOrder.php" class="btn btn-primary"><i class="fas fa-plus"></i> 新增課程訂單</a>
                </div>
                <div class="d-flex">
                    ...
                    <?php if(isset($p)): ?>
                        <nav aria-label="Page navigation example ">
                            <ul class="pagination justify-content-center">
                                <li class="page-item"><a class="page-link" href="service.php?p=1">第一頁</a></li>
                                <?php for($i=1;$i<=$pageCount; $i++) :?>
                                    <!--當下頁數跟頁碼相同時echo active 寫在li class裡面-->
                                    <li class="page-item <?php if($p==$i) echo "active" ?>">
                                        <a class="page-link" href="service.php?p=<?=$i?>"><?=$i?></a></li>
                                <?php endfor; ?>
                                <li class="page-item"><a class="page-link" href="service.php?p=<?=$pageCount?>"> 最末頁</a></li>
                            </ul>
                        </nav>
                    <?php endif; ?>
                <?php else : ?>
